# SignalForge: Crypto trading signal generator using ensemble machine learning Implementation
> Advanced javascript solution leveraging modern architecture patterns and cutting-edge AI technology.

SignalForge combines on-chain flow data, social sentiment, and order-book microstructure features in an ensemble of gradient-boosted trees and LSTM models to generate directional trading signals.

SignalForge's key benefits include:
...
```bash
git clone https://github.com/Devnilethegreat/SignalForge.git
cd SignalForge
```
...
- **2024-07-14** — Expand test coverage for edge cases
- **2025-01-27** — Expand test coverage for edge cases
- **2025-05-01** — Expand test coverage for edge cases
